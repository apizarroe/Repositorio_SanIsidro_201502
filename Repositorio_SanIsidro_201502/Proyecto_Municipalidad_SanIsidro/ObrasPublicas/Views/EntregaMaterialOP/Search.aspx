...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Municipalidad de San Isidro - Calendario de Entrega de Materiales
</asp:Content>
    ...
    <section class="content-header" style="padding-bottom:5px">
        ...
        <div id="divControlButtons" class="panel panel-default">
            <div class="panel-body">
                <button id="btnIconCrear" type="button" class="btn btn-default" onclick="document.location.href='/entregamaterialop/index'">
    ...
    <div id="divPanelCrear" class="panel panel-primary">
            ...
            <div class="panel-body">
                <%
                    ...
                    objSearchProyectoInversionModel.Tipo = "EMU";
                     %>
