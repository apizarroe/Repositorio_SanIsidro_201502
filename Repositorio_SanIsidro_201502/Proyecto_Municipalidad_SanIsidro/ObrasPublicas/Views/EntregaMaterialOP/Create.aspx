<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site_Intranet.Master" Inherits="System.Web.Mvc.ViewPage<ObrasPublicas.Models.EntregaMaterialOP.CreateEntregaMaterialOP>" %>
    ...
    <div id="divPanelCrear" class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-horizontal" role="form">
                <% using (Html.BeginForm("Create", "EntregaMaterialOP", FormMethod.Post, new { @name = "frmCreate", @id = "frmCreate" }))
                { %>
