<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site_Intranet.Master" Inherits="System.Web.Mvc.ViewPage<ObrasPublicas.Models.ExpedienteTecnicoOP.CreateExpedienteTecnicoOPModel>" %>
    ...
    <div id="divPanelCrear" class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="form-horizontal" role="form">
                    <% using (Html.BeginForm("Create", "ExpedienteTecnicoOP", FormMethod.Post, new { @name = "frmCreate", @id = "frmCreate", enctype = "multipart/form-data"}))
                       { %>
