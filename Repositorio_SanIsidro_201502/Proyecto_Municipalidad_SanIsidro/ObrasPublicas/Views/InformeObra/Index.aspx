    ...
    <section class="content-header" style="padding-bottom:5px">
        ...
        <div id="divControlButtons" class="panel panel-default">
            <div class="panel-body">
                <button id="btnIconCrear" type="button" class="btn btn-primary" onclick="document.location.href='/informeobra/index'">
                    <span class="fa fa-file" aria-hidden="true"></span> Crear
                </button>
                <button id="btnIconModificar" type="button" class="btn btn-default" onclick="document.location.href='/informeobra/search'">
    ...
    <div id="divPanelCrear" class="panel panel-primary">
            ...
            <div class="panel-body">
                <%
                    ...
                    objSearchProyectoInversionModel.Tipo = "CIO";
                     %>
