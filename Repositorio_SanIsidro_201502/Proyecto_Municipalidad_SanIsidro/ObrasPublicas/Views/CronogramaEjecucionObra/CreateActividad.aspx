<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site_Intranet.Master" Inherits="System.Web.Mvc.ViewPage<ObrasPublicas.Models.CronogramaEjecucionObra.CreateActividadCronogramaEjecucionModel>" %>
...
<%
    ...
    var lstEmpleadosEmpresa = objCronogramaEjecucionObra_DAL.ObtieneEmpleadosPersonaJuridica().Select(x =>
                                                                        new SelectListItem
                                                                        {
                                                                            Value = x.Id,
                                                                            Text = x.Nombre
...
%>
    ...
    <div id="divPanelCrear" class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">Crear Actividad</h3>
            </div>
            <div class="panel-body">
                <div class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div id="Err_ResponsableActTipo" class="field-validation-error"></div>
                    </div>
                    </div>
                    <div id="divResponsablePersona" style="display:none">
                        <div class="form-group">
                    ...
                    <div id="divResponsableEmpresa" style="display:none">
                        <div class="form-group">
