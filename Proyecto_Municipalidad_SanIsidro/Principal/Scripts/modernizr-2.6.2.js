...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['flexboxlePrincipaly'] = function() {
    ...
    // For speed, we don't test the lePrincipaly (and beta-only) indexedDB
    ...
    tests['cssgradients'] = function() {
        ...
        setCss(
             // lePrincipaly webkit syntax (FIXME: remove when syntax not in use anymore)
